...
#' This formulation is designed to work with who-infects-who transmission formulation
#'  
...
#'                n.age.cats = 12, p = 0.43, beta.ff = 0.07, gamma.mm = 1, gamma.mf = 1, 
#'                gamma.fm = 1, theta = 1, n0 = 2000, stable.stage.pop = TRUE)
#' 
#' R0_NGM_wiw(params)
#' 
#' @export
...
R0_NGM_wiw <- function(params, stable.stage.pop = TRUE){
