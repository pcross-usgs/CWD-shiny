...
#' @param example name of the application to run. Current apps are "CWDapp" and 
#' "CWDapp_wiw". The latter (who-infects-who model) allows for differential 
#' transmission from females to males and males to females.
#' 
#' 
#' @export
#'
