...
# Welcome to the CWD simulation main page 

<img src="figures/logo.png" alt="CWDsims" height="150px" align="right" />

Link to the base application where males and females have different susceptibility: [Base Application](https://rconnect.usgs.gov/CWD_baseapp/)

Link to the who-infects-whom application with four different transmission rates--within males, within females, from males to females and from females to males: [WIW Application](https://rconnect.usgs.gov/CWD_wiwapp/)

Link to the predator-prey-CWD application: [Predator Application](https://rconnect.usgs.gov/CWD_predapp/)
